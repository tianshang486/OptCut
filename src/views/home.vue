...
import Translate from '@/components/menu/Translate.vue'
  ...
  <div class="flex h-screen bg-gray-900 text-gray-200">
      ...
      <ul class="menu list-none p-0 space-y-1">
        <li @click="switchMenu('system')"
          ...
          <a class="flex items-center space-x-1.5">
            ...
            <span class="truncate">{{ t('menu.system') }}</span>
          </a>
        </li>
        <li @click="switchMenu('Ocr')"
          ...
          <a class="flex items-center space-x-1.5">
            ...
            <span class="truncate">{{ t('menu.ocr') }}</span>
          </a>
        </li>
        <li @click="switchMenu('shortcutKey')"
          ...
          <a class="flex items-center space-x-1.5">
            ...
            <span class="truncate">{{ t('menu.shortcutKey') }}</span>
          </a>
        </li>
        <li @click="switchMenu('Translate')"
            :class="{ 'bg-gray-700': currentMenu === 'Translate' }"
            class="cursor-pointer hover:bg-gray-700 rounded p-1.5">
          <a class="flex items-center space-x-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <span class="truncate">{{ t('menu.translate') }}</span>
          </a>
        </li>
        <li @click="switchMenu('test')"
          ...
          <a class="flex items-center space-x-1.5">
            ...
            <span class="truncate">{{ t('menu.test') }}</span>
          </a>
        </li>
      </ul>
    </div>
    ...
    <div class="flex-1 p-4 bg-gray-700 overflow-y-auto">
      <component :is="currentMenu === 'system' ? system :
                     ...
                     currentMenu === 'Translate' ? Translate :
                     Test"/>
    </div>
  </div>
</template>
